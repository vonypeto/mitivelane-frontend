  ...
  return (
    ...
    >
      ...
      <div className="pt-1 text-center">
        <Tag
          className="mr-0 font-size-md"
          color={tagStatusColor(data?.settlement_status)}
        >
          ...
          <Col xs={24} sm={24} md={24} className="w-100">
            <Row className="pt-3 mt-2 mb-2 bt-1 border-top ">
              ...
              <Col xs={12} sm={12} md={15} className="text-right">
                <span className="ml-5 font-weight-bold">{data?.subject}</span>
              </Col>
            </Row>
